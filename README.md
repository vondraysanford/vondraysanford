...
- **[Cataclysm-DDA](https://github.com/CleverRaven/Cataclysm-DDA/pulls?q=author%3Avondraysanford)** (13K+ ⭐) — Fixed the solar cell's implausible half-meter `longest_side` and added `looks_like` sprite fallbacks for the Xedra Evolved dream weapons across 2 PRs (open, awaiting review — Aug 2026)
